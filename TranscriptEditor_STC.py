...
class TranscriptEditor(RichTextEditCtrl.RichTextEditCtrl):
    ...
    def __init__(self, parent, id=-1, stylechange_cb=None, updateSelectionText=False):
        ...
        RichTextEditCtrl.RichTextEditCtrl.__init__(self, parent)
...
#			}
    ...
    def ClearDoc(self):
        ...
        RichTextEditCtrl.RichTextEditCtrl.ClearDoc(self)
